...
file_path = '/home/santiago/universidad/arquitectura/scripts/stats.txt'
...
plt.title('Profiling', fontsize=15)
...
csv_path = '/home/santiago/universidad/arquitectura/scripts/output.csv'
